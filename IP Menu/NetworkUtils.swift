...
//        
//        let so_dst_sa: UnsafeMutablePointer<sockaddr> = unsafeBitCast(so_dst, to: UnsafeMutablePointer<sockaddr>.self);
...
//        
//        cp = unsafeBitCast(buffer.advanced(by: MemoryLayout<rt_msghdr>.size), to: UnsafeMutableRawPointer.self);
//        rtm = unsafeBitCast(buffer, to: UnsafeMutablePointer<rt_msghdr>.self);
//
//        so_dst_sa.pointee.sa_family = sa_family_t(AF_INET);
//        so_dst_sa.pointee.sa_len = __uint8_t(MemoryLayout<sockaddr_in>.size);
//        so_ifp_sa.pointee.sdl_family = sa_family_t(AF_LINK);
//        so_ifp_sa.pointee.sdl_len = __uint8_t(MemoryLayout<sockaddr_dl>.size);
...
//        var index_n = 0;
//        
//        index_n = NEXTADDR(Int(RTA_DST), u: so_dst_sa, rtm_addrs: Int((rtm?.pointee.rtm_addrs)!), cp: cp!);
//        cp = cp?.advanced(by: index_n);
//        index += index_n;
//
//        index_n = NEXTADDR(Int(RTA_GATEWAY), u: so_gate_sa, rtm_addrs: Int((rtm?.pointee.rtm_addrs)!), cp: cp!);
//        cp = cp?.advanced(by: index_n);
//        index += index_n;
//
//        index_n = NEXTADDR(Int(RTA_NETMASK), u: so_mask_sa, rtm_addrs: Int((rtm?.pointee.rtm_addrs)!), cp: cp!);
//        cp = cp?.advanced(by: index_n);
//        index += index_n;
//        
//        index_n = NEXTADDR(Int(RTA_GENMASK), u: so_genmask_sa, rtm_addrs: Int((rtm?.pointee.rtm_addrs)!), cp: cp!);
//        cp = cp?.advanced(by: index_n);
//        index += index_n;
//
//        index_n = NEXTADDR_dl(Int(RTA_IFP), u: so_ifp_sa, rtm_addrs: Int((rtm?.pointee.rtm_addrs)!), cp: cp!);
//        cp = cp?.advanced(by: index_n);
//        index += index_n;
//        
//        index_n = NEXTADDR(Int(RTA_IFA), u: so_ifa_sa, rtm_addrs: Int((rtm?.pointee.rtm_addrs)!), cp: cp!);
//        cp = cp?.advanced(by: index_n);
//        index += index_n;
//
...
//                print("Message indicates error \(rtm?.pointee.rtm_errno)");
//            }
//
...
//
//                    sdl_data.deinitialize(count: ll);
//                }
//            }
//        }
//
//        // Cleanup
//        so_dst.deinitialize(count: 1);
//        so_gate.deinitialize(count: 1);
//        so_mask.deinitialize(count: 1);
//        so_genmask.deinitialize(count: 1);
//        so_ifp.deinitialize(count: 1);
//        so_ifa.deinitialize(count: 1);
//
//        buffer.deinitialize(count: buffer_length);
//
//        return defaultIF;
//    }
//
